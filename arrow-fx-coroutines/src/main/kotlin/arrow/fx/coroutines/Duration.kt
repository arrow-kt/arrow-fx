...
@Deprecated(
  ...
  ReplaceWith("Duration", "kotlin.time.Duration"),
...
data class Duration(val amount: Long, val timeUnit: TimeUnit) {
  ...
  companion object {
    ...
    @Deprecated(
      "Redundant property please use in kotlin.time.Duration.INFINITE",
      ReplaceWith("Duration.INFINITE", "kotlin.time.Duration.INFINITE"),
      DeprecationLevel.ERROR
    )
    val INFINITE: Duration = Duration(amount = Long.MAX_VALUE, timeUnit = TimeUnit.DAYS)
  }

  @Deprecated("Redundant operator please use in kotlin.time.Duration")
...
@Deprecated(
  "Redundant since 0.12.0 will provide automatic integration with kotlin.time and KotlinX",
  ReplaceWith("days", "kotlin.time.days"),
  DeprecationLevel.ERROR
)
...
@Deprecated(
  "Redundant since 0.12.0 will provide automatic integration with kotlin.time and KotlinX",
  ReplaceWith("hours", "kotlin.time.hours"),
  DeprecationLevel.ERROR
)
...
@Deprecated(
  "Redundant since 0.12.0 will provide automatic integration with kotlin.time and KotlinX",
  ReplaceWith("microseconds", "kotlin.time.microseconds"),
  DeprecationLevel.ERROR
)
...
@Deprecated(
  "Redundant since 0.12.0 will provide automatic integration with kotlin.time and KotlinX",
  ReplaceWith("minutes", "kotlin.time.minutes"),
  DeprecationLevel.ERROR
)
...
@Deprecated(
  "Redundant since 0.12.0 will provide automatic integration with kotlin.time and KotlinX",
  ReplaceWith("milliseconds", "kotlin.time.milliseconds"),
  DeprecationLevel.ERROR
)
...
@Deprecated(
  "Redundant since 0.12.0 will provide automatic integration with kotlin.time and KotlinX",
  ReplaceWith("nanoseconds", "kotlin.time.nanoseconds"),
  DeprecationLevel.ERROR
)
...
@Deprecated(
  "Redundant since 0.12.0 will provide automatic integration with kotlin.time and KotlinX",
  ReplaceWith("seconds", "kotlin.time.seconds"),
  DeprecationLevel.ERROR
)
